...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/ASSEMBLY_4/ASSEMBLY_4.runs/ASSEMBLY_5_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASSEMBLY_5_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASSEMBLY_5_proc_sys_reset_0_0.tcl
