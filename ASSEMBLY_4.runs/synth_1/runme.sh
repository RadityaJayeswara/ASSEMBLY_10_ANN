...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/ASSEMBLY_4/ASSEMBLY_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASSEMBLY_5_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASSEMBLY_5_wrapper.tcl
