...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/ASSEMBLY_4/ASSEMBLY_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASSEMBLY_5_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ASSEMBLY_5_wrapper.tcl -notrace
