...
\
  ...
  set axis_ann_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_ann:1.0 axis_ann_0 ]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axis_ann_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
